...
$shirt_type="Cotton Colour Checked Shirt Fabric Sky Blue Galaxy Art";
$order_total=445;
...
<header>
    ...
    <p>Shirt type : Cotton Colour Checked Shirt Fabric Sky Blue Galaxy Art</p>
    <p>Order value : Rs. 425.00<br>
