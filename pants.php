    ...
    <main>
      <div class="fabric">
          <div class="shirt">
              ...
              <p><i class="fa-solid fa-indian-rupee-sign" style="color: #fff6e5;"></i> <Rs class="money"></Rs>545.00</p>
          ...
          <div class="shirt">
              ...
              <p><i class="fa-solid fa-indian-rupee-sign" style="color: #fff6e5;"></i> <Rs class="money"></Rs>655.00</p>
              <div class="placeorder">
                <a href="#"><button><i class="fa-solid fa-cart-shopping" style="color: #062f3d;"></i> Place Order</button></a>
              </div>
          ...
          <div class="shirt">
              ...
              <p><i class="fa-solid fa-indian-rupee-sign" style="color: #fff6e5;"></i> <Rs class="money"></Rs>625.00</p>
              <div class="placeorder">
                <a href="#"><button><i class="fa-solid fa-cart-shopping" style="color: #062f3d;"></i> Place Order</button></a>
              </div>
          ...
          <div class="shirt">
              ...
              <p><i class="fa-solid fa-indian-rupee-sign" style="color: #fff6e5;"></i> <Rs class="money"></Rs>660.00</p>
              <div class="placeorder">
                <a href="#"><button><i class="fa-solid fa-cart-shopping" style="color: #062f3d;"></i> Place Order</button></a>
              </div>
          ...
          <div class="shirt">
              ...
              <p><i class="fa-solid fa-indian-rupee-sign" style="color: #fff6e5;"></i> <Rs class="money"></Rs>670.00</p>
              <div class="placeorder">
                <a href="#"><button><i class="fa-solid fa-cart-shopping" style="color: #062f3d;"></i> Place Order</button></a>
              </div>
          ...
          <div class="shirt">
              ...
              <p><i class="fa-solid fa-indian-rupee-sign" style="color: #fff6e5;"></i> <Rs class="money"></Rs>695.00</p>
              <div class="placeorder">
                <a href="#"><button><i class="fa-solid fa-cart-shopping" style="color: #062f3d;"></i> Place Order</button></a>
              </div>
          ...
          <div class="shirt">
              ...
              <p><i class="fa-solid fa-indian-rupee-sign" style="color: #fff6e5;"></i> <Rs class="money"></Rs>740.00</p>
              <div class="placeorder">
                <a href="#"><button><i class="fa-solid fa-cart-shopping" style="color: #062f3d;"></i> Place Order</button></a>
              </div>
